...
/**
 * The Bedigas class is a static representation of the framework.
 *
 * Core.
 ...
 * @method  static \bedigas\template\View view() Returns View instance.
 *
 * Request & Response.
...
class Bedigas {
    ...
    public static function __callStatic($name, $params) {
        ...
        return \bedigas\core\Dispatcher::invokeMethod(array($app, $name), $params);
    }

    /**
     * @return \bedigas\Engine Application instance
     */
    public static function app() {
        ...
        if (!$initialized) {
            ...
            self::$engine = new \bedigas\Engine();
